const navigation = {
  categories: [
    { name: "Felsefe", href: "Felsefe" },
    { name: "Sinema", href: "Sinema" },
    { name: "Ekonomi", href: "Ekonomi" },
    { name: "Edebiyat", href: "Edebiyat" },
  ],
  support: [
    { name: "Ana Sayfa", href: "/" },
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/dergifalan/?igshid=NzZhOTFlYzFmZQ%3D%3D",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-10 xl:mt-0">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-300">
              Yeni yazılarımızdan, dergilerimizden ve yazarlarımızdan haberdar
              olmak için e-posta adresinizi girin.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; {new Date().getFullYear()} Falan Dergisi, Tüm Hakları
            Saklıdır.
          </p>
        </div>
      </div>
